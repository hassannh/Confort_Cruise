    ...
    <form method="POST" action="<?= URLROOT ?>cruiseController/add_cruise">
        <div class="mt-8 grid lg:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select class="block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full " required name="ship">
            ...
            <div>
                ...
                <select class="block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full " required name="ports">
            ...
            <div class="mb-3">
                ...
                <div class="container">
                    <div class="row">
                        <input type="text" name="trajet" id="traget" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" required >
