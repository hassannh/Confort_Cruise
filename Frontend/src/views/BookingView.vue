<template>
  ...
  <input class="h-full outline-none text-sm text-gray-700 mx-5 my-5" type="text" v-model="searchQuery" placeholder="Search something.." id="search" />
          ...
          >
            ...
            >
              <div class="absolute inset-0 bg-black">
                <img :src="'../../public/pictures/' + cruise.picture" />
              </div>
            </div>
          ...
          <div class="grid grid-cols-2 mt-8">
            ...
            <div class="flex justify-end">
              ...
              >
                ...
                <span class="text-lg">{{ cruise.price }}</span
                >/$
              </p>
            </div>
          </div>
